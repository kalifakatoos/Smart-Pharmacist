...
لمزيد من التفاصيل حول البنية والخطوات القادمة، راجع ملف [DESIGN.md](DESIGN.md).
...
سيفتح التطبيق على المحاكي أو الهاتف المتصل، لتجربة البحث عن الأدوية من خلال واجهة بسيطة.

## Environment

The environment lacks Flutter and Dart tooling.
